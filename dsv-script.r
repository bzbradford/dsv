...
# copy loggernet data into local dir
...
plo.hourly = loadDat("plo.dat", "Plover") %>% filter(Date >= "2019-05-01")
han.hourly = loadDat("han.dat", "Hancock") %>% filter(Date >= "2019-05-01")
...
write.csv(plo.hourly, "plo19-hourly.csv")
write.csv(plo, "plo19.csv")
write.csv(han.hourly, "han19-hourly.csv")
